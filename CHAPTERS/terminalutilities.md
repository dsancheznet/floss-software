...
[Github](https://micro-editor.github.io/)
...
> A generic shell script compiler. Shc takes a script, which is specified on the command line and produces C source code. The generated source code is then compiled and linked to produce a stripped binary executable. shc itself is not a compiler such as cc, it rather encodes and encrypts a shell script and generates C source code with the added expiration capability. It then uses the system compiler to compile a stripped binary which behaves exactly like the original script. Upon execution, the compiled binary will decrypt and execute the code with the shell -c option.

[https://neurobin.org/projects/softwares/unix/shc/](https://neurobin.org/projects/softwares/unix/shc/)
...
[Github - Bashtop](https://github.com/aristocratos/bashtop)

[Github - Bpytop](https://github.com/aristocratos/bpytop)
...
[Github](https://github.com/svartalf/rust-battop)
